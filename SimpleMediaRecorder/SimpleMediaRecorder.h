...
#define SIMPLE_MEDIA_RECORDING_THREAD_TIMEOUT 5000
...
typedef struct _SIMPLE_MEDIA_RECORDING_CONTEXT {
	PSIMPLE_MEDIA_INPUT Input;
	LPSTR RecordingDirectory;
} SIMPLE_MEDIA_RECORDING_CONTEXT, *PSIMPLE_MEDIA_RECORDING_CONTEXT;
